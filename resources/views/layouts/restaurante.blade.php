...
<body id="page-top" class="index">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li>
						<a class="page-scroll" href="{{ route('guia.index') }}">GUIA DE RESTAURANTES</a>
					</li>
					<li>
						<a class="page-scroll" href="#menu">MENU</a>
					</li>
					<li>
						<a class="page-scroll" href="#ubicanos">UBICANOS</a>
					</li>
					<li>
	...
	<!-- Google Maps API -->
	<script src="https://maps.googleapis.com/maps/api/js?callback=initMapQuinoa" async defer></script>
